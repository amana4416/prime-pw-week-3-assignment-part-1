...
let favoriteFoods = ['pizza', 'waffles', 'butter chicken', 'pineapple'];
...
favoriteFoods.push('french fries');
...
favoriteFoods.unshift('donuts');
console.log('Added a new favorite food to the beginning: ', favoriteFoods);
...
console.log('My updated list of favorite foods includes:', favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
let order = favoriteFoods.sort()
let reverse = order.reverse()
console.log('Reversed Alphabetical Foods:',reverse);

// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.
let convert = favoriteFoods.join(" and ")
console.log(convert);
...
console.log('Combined favorite foods and animals:',newArray);